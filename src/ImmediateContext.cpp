...
ImmediateContext::ImmediateContext(UINT nodeIndex, D3D12_FEATURE_DATA_D3D12_OPTIONS& caps, 
    ...
    , m_UploadBufferPool(min(max((UINT64)args.BufferPoolTrimThreshold, m_MinBufferPoolTrimThreshold), m_MaxBufferPoolTrimThreshold), args.CreatesAndDestroysAreMultithreaded)
    , m_ReadbackBufferPool(min(max((UINT64)args.BufferPoolTrimThreshold, m_MinBufferPoolTrimThreshold), m_MaxBufferPoolTrimThreshold), args.CreatesAndDestroysAreMultithreaded)
    , m_DecoderBufferPool(min(max((UINT64)args.BufferPoolTrimThreshold, m_MinBufferPoolTrimThreshold), m_MaxBufferPoolTrimThreshold), args.CreatesAndDestroysAreMultithreaded)
    , m_uStencilRef(0)
